...
> - v3.1 修正：確認 CEPII 下載不需要帳號；補充 HS22 說明；更正下載網址；確認每個 BACI 版本為單一 zip；HS 對照表方向反轉修正
> - v3.2 修正：**HS 對照表瀏覽頁網址無效，改為兩個直接下載連結**
>
